...
Oracle Autonomous Data Warehouse Cloud supports storing JSON documents inside the database. Use following code to create a table to store the transaction log which is in JSON format
*/
BEGIN
